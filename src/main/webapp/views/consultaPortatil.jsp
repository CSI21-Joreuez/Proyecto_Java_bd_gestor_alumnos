...
<form method="post" action="consultaPortatil">
        <div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4 col-form-label" style="text-align: center; font-size: 1cm;">Consulta Portatil</div>
            </div>
            ...
            <div class="form-group row">
                <div class="col-sm-4 col-form-label"></div>
                <div class="col-sm-4 col-form-label">Id del Alumno a Buscar</div>
            </div>
            <div class="form-group row">
                <div class="col-sm-4 col-form-label"></div>
                <div class="col-sm-4">
